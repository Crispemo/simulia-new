      ...
      <section data-aos="fade-up" id="modalidades" className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        <div className="flex flex-wrap justify-center gap-4 max-w-4xl mx-auto">
          {[
            ...
            <div
              key={idx}
              className={`w-[calc(50%-0.5rem)] sm:w-[calc(33.333%-0.667rem)] lg:w-[calc(25%-0.75rem)] flex flex-col items-center text-center gap-2 p-5 rounded-xl border-2 transition-all duration-300 hover:-translate-y-1 cursor-pointer group shadow-sm hover:shadow-soft ${
                item.highlight
